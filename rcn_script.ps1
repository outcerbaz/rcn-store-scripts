...
Do {
    ...
    Switch ($escolha) {
        1 { Write-Host "Criar ponto de restauração..." }
        2 { Write-Host "Excluir arquivos temporários..." }
        3 { Write-Host "Desativar Consumer Features..." }
        4 { Write-Host "Desativar Telemetria..." }
        5 { Write-Host "Desativar Histórico de Atividades..." }
        6 { Write-Host "Desativar GameDVR..." }
        7 { Write-Host "Desativar Hibernação..." }
        8 { Write-Host "Desativar Homegroup..." }
        9 { Write-Host "Preferir IPv4 ao invés de IPv6..." }
        10 { Write-Host "Desativar Rastreamento de Localização..." }
        11 { Write-Host "Desativar Storage Sense..." }
        12 { Write-Host "Desativar Wifi-Sense..." }
        13 { Write-Host "Habilitar Finalizar Tarefa com Botão Direito..." }
        ...
        17 { Write-Host "Configurar Hibernação como padrão..." }
