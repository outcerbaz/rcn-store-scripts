...
Function OutrasOtimizacoes {
    Do {
        ...
        Write-Host "[9] Desativar Barra de Notificações e Calendário"
        Write-Host "[10] Configurar Tela para Melhor Desempenho"
        Write-Host "[11] Ativar Menu Clássico do Clique-Direito"
        ...
        Write-Host "[16] Bloquear Instalações de Software Razer"
        Write-Host "[0] Voltar"
        Write-Host "----------------------------------------"

        $opcao = Read-Host "Digite o número da sua escolha"
        Switch ($opcao) {
            ...
            9 { Write-Host "Desativando Barra de Notificações e Calendário..." }
            10 { Write-Host "Configurando Tela para Melhor Desempenho..." }
            11 { Write-Host "Ativando Menu Clássico do Clique-Direito..." }
            ...
            16 { Write-Host "Bloqueando Instalações de Software Razer..." }
...
Do {
    ...
    Write-Host "[21] Outras Otimizações"
    Write-Host "[0] Sair"
    Write-Host "----------------------------------------"

    $escolha = Read-Host "Digite o número da sua escolha"
    Switch ($escolha) {
        1 { Write-Host "Criando ponto de restauração..." }
        2 { Write-Host "Excluindo arquivos temporários..." }
